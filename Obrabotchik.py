...
def generateRecomendation():
    ExpensesInMounth = expenses.get_all_statistics_per_month_notstring() # выводит расходы за месяц
    Dict_AllExpenses = expenses.get_all_AllExpenses() #выводит расходы в сумме по категориям
